...
var Sidebar = function (_Component) {
  ...
  Sidebar.prototype.selectItem = function selectItem(itemID) {
  ...
  Sidebar.prototype.displayItems = function displayItems() {
    ...
    return this.state.items.map(function (item) {
      var className = "";
      if (item.id === _this2.state.selectedItem) {
        className = "selected";
      }
      return _react2.default.createElement(
        "li",
        {
          onClick: function onClick(e) {
            return _this2.selectItem(item.id);
          },
          className: className,
          key: item.id
        },
