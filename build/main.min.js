...
exports.isBrowserIOS = isBrowserIOS;
exports.shallowObjectToQueryStringParams = shallowObjectToQueryStringParams;
var SM = exports.SM = 576;
var MD = exports.MD = 768;
var LG = exports.LG = 992;
var XL = exports.XL = 1200;
...
function isBrowserMobile() {
  return window.navigator.userAgent.toLowerCase().match(/(ipad)|(iphone)|(ipod)|(android)|(webos)/i);
}

function isBrowserIOS() {
  return window.navigator.userAgent.toLowerCase().match(/(ipad)|(iphone)|(ipod)/i);
}

function shallowObjectToQueryStringParams(obj) {
  var queryStringParams = "";
  if (Object.keys(obj).length > 0) {
    queryStringParams += "?";
    queryStringParams += Object.keys(obj).map(function (key) {
...
var _seat = __webpack_require__(35);
...
var SeatList = function (_Component) {
  _inherits(SeatList, _Component);

  function SeatList(props) {
    _classCallCheck(this, SeatList);

    return _possibleConstructorReturn(this, _Component.call(this, props));
  }

  SeatList.prototype.render = function render() {
    var _this2 = this;

    if (!this.props.basket || !this.props.basket.seatBundles || this.props.basket.seatBundles.length === 0) {
      return null;
    }

    var seats = [];

    this.props.basket.seatBundles.forEach(function (bundle) {
      bundle.seats.forEach(function (seat) {
        seats.push(_react2.default.createElement(_seat2.default, {
          key: seat.uuid,
          bundle: bundle,
          seat: seat,
          legendItem: _this2.props.availability.legend[seat.legend],
          currency: _this2.props.availability.currency,
          block: _this2.props.availability.seat_blocks[seat.seat_block],
          onClick: _this2.props.onSeatClick,
          removable: _this2.props.seatsAreRemovable,
          removeSeat: _this2.props.removeSeat
        }));
      });
    });
...
// module
exports.push([module.i, ".gradient-vertical-2 {\n  background: #8f42ff;\n  /* Old browsers */\n  /* FF3.6-15 */\n  /* Chrome10-25,Safari5.1-6 */\n  background: linear-gradient(to bottom, #d882a5 0%, #8f42ff 100%);\n  /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */\n}\n.gradient-vertical-1 {\n  background: #f4b793;\n  /* Old browsers */\n  /* FF3.6-15 */\n  /* Chrome10-25,Safari5.1-6 */\n  background: linear-gradient(to bottom, #d66d8d 0%, #f4b793 100%);\n  /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */\n}\n.item {\n  background-color: #ffffff;\n  margin: 5px;\n  margin-left: 0;\n  padding: 5px 25px;\n  border-radius: 50px;\n  display: inline-block;\n  border: 1px solid #d882a5;\n  font-size: 0.8em;\n  font-weight: 700;\n}\n.item-interactive {\n  background-color: #ffffff;\n  margin: 5px;\n  margin-left: 0;\n  padding: 5px 25px;\n  border-radius: 50px;\n  display: inline-block;\n  border: 1px solid #d882a5;\n  font-size: 0.8em;\n  font-weight: 700;\n  cursor: pointer;\n}\n.item-interactive:hover,\n.item-interactive.selected {\n  background-color: #d882a5;\n  color: #ffffff;\n}\n.standard-button {\n  background-color: #d882a5;\n  display: inline-block;\n  width: 100%;\n  padding: 5px 20px;\n  border-radius: 50px;\n  color: white;\n  border: 0;\n  font-size: 1em;\n  margin-bottom: 10px;\n  cursor: pointer;\n}\n.standard-button:hover {\n  opacity: 0.7;\n}\n.sidebar {\n  width: 300px;\n  background-color: #ffffff;\n  text-align: center;\n}\n.sidebar .logo {\n  width: 40px;\n}\n.sidebar .icon-feather path {\n  color: #d882a5;\n}\n.sidebar .menu {\n  max-height: calc(100vh - 130px);\n  overflow: auto;\n}\n.sidebar small {\n  opacity: 0.5;\n  margin-bottom: 10px;\n  display: inline-block;\n  font-size: 0.85em;\n}\n.sidebar ul li {\n  font-size: 0.85em;\n  border-top: 2px solid #f8f9fa;\n  border-bottom: 2px solid #f8f9fa;\n  color: #555;\n  margin-top: -2px;\n  position: relative;\n  cursor: pointer;\n  transition: background-color 300ms;\n  text-align: left;\n  font-weight: 700;\n}\n.sidebar ul li .arrow {\n  position: absolute;\n  right: 10px;\n  font-size: 0.8em;\n  opacity: 0.3;\n  transform: translate(-50%, -50%);\n  top: 50%;\n}\n.sidebar ul li .icon {\n  margin-right: 10px;\n  margin-left: 30px;\n  font-size: 1.4em;\n  vertical-align: middle;\n}\n.sidebar ul li label {\n  position: relative;\n  display: block;\n  padding-top: 15px;\n  padding-bottom: 15px;\n  cursor: pointer;\n  opacity: 0.35;\n}\n.sidebar ul li label:hover {\n  background-color: #f8f9fa;\n}\n.sidebar ul li label.selected,\n.sidebar ul li label:hover {\n  opacity: 1;\n}\n.sidebar ul li label.selected:after,\n.sidebar ul li label:hover:after {\n  content: \"\";\n  width: 4px;\n  position: absolute;\n  height: calc(100% + 0px);\n  left: 0;\n  top: 0px;\n  background-color: #8f42ff;\n  border-radius: 5px;\n  background: #f4b793;\n  /* Old browsers */\n  /* FF3.6-15 */\n  /* Chrome10-25,Safari5.1-6 */\n  background: linear-gradient(to bottom, #d66d8d 0%, #f4b793 100%);\n  /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */\n}\n.sidebar ul li label.selected .icon,\n.sidebar ul li label:hover .icon {\n  background: -webkit-linear-gradient(#f4b793, #d66d8d);\n  -webkit-background-clip: text;\n  -webkit-text-fill-color: transparent;\n}\n.sidebar ul li .event-log > li {\n  padding-top: 15px;\n  padding-bottom: 15px;\n  font-size: 0.8em;\n  opacity: 0.6;\n  cursor: pointer;\n  padding-left: 10px;\n}\n.sidebar ul li .event-log > li:hover,\n.sidebar ul li .event-log > li.selected {\n  opacity: 1;\n  font-weight: 700;\n  background-color: #f8f9fa;\n}\n.sidebar .event-log {\n  padding-left: 48px;\n  margin-top: 10px;\n}\n.sidebar .event-log li {\n  font-weight: 400;\n  color: #000;\n}\n.basket {\n  height: 160px;\n  margin-top: 10px;\n  background-color: #f8f9fa;\n  padding-left: 20px;\n  padding-right: 20px;\n  padding-top: 15px;\n  overflow: auto;\n  transition: 600ms;\n  transition-timing-function: ease-in-out;\n}\n.basket .header {\n  background-color: #ffffff;\n  color: #555;\n  border: 1px solid #ffffff;\n  padding: 12px 20px;\n  border-radius: 50px;\n  letter-spacing: 1px;\n  font-size: 1em;\n  opacity: 0.5;\n  font-size: 0.85em;\n  font-weight: 500;\n  position: relative;\n}\n.basket .header .subtitle {\n  display: block;\n  margin-left: 25px;\n  font-size: 0.85em;\n  opacity: 0.7;\n  letter-spacing: 1px;\n}\n.basket .header i {\n  margin-right: 10px;\n}\n.basket .proceed {\n  border: 1px dashed #555;\n  color: #555;\n  opacity: 0.3;\n  background-color: transparent;\n  padding: 6px 20px;\n  border-radius: 50px;\n  letter-spacing: 1px;\n  font-size: 0.9em;\n  cursor: pointer;\n  position: absolute;\n  transform: translate(0, -50%);\n  right: 20px;\n  top: 50%;\n  pointer-events: none;\n}\n.basket .proceed.enabled {\n  color: #ffffff;\n  background-color: #d882a5;\n  border: 1px solid #d882a5;\n  opacity: 1;\n  pointer-events: all;\n  z-index: 1;\n}\n.basket .proceed.enabled:hover {\n  opacity: 0.7;\n}\n.basket .reserve {\n  color: #555;\n  background-color: transparent;\n  opacity: 0.2;\n  padding: 9px 20px;\n  border-radius: 50px;\n  font-weight: 700;\n  letter-spacing: 2px;\n  font-size: 1em;\n  border: 1px dashed #555;\n  width: 50%;\n  max-width: 300px;\n  margin: 0 auto;\n  margin-top: 30px;\n  display: block;\n  pointer-events: none;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n}\n.basket .reserve.enabled {\n  background-color: #d882a5;\n  border: 2px solid #d882a5;\n  color: #ffffff;\n  font-weight: 500;\n  opacity: 1;\n  pointer-events: all;\n  cursor: pointer;\n}\n.basket .reserve.enabled:hover {\n  opacity: 0.7;\n}\n.basket .seats {\n  margin: 0;\n  margin-top: 5px;\n}\n.basket .seats li {\n  cursor: pointer;\n  background-color: #ffffff;\n  margin: 5px;\n  margin-left: 0;\n  padding: 5px 25px;\n  border-radius: 50px;\n  display: inline-block;\n  border: 1px solid #d882a5;\n  font-size: 0.8em;\n  font-weight: 700;\n}\n.basket .seats li:hover {\n  background-color: #f8f9fa;\n}\n.basket .seats li .description {\n  font-weight: 700;\n}\n.basket .seats li .remove {\n  margin-left: 10px;\n  margin-right: -15px;\n  margin-left: 20px;\n  border: 1px solid #d882a5;\n  border-radius: 50%;\n  width: 17px;\n  height: 17px;\n  position: relative;\n  top: -1px;\n  text-align: center;\n  font-size: 0.8em;\n  line-height: 17px;\n  cursor: pointer;\n  transition: all 300ms;\n  color: #d882a5;\n}\n.basket .seats li .remove:hover {\n  background-color: #d66d8d;\n  border-color: #d66d8d;\n  color: #ffffff;\n  opacity: 1;\n}\n.basket .part-2 {\n  margin-top: 10px;\n}\n.basket.active .header {\n  opacity: 1;\n}\n.basket.expanded {\n  height: 100%;\n}\n.basket .send-methods li {\n  background-color: #ffffff;\n  margin: 5px;\n  margin-left: 0;\n  padding: 5px 25px;\n  border-radius: 50px;\n  display: inline-block;\n  border: 1px solid #d882a5;\n  font-size: 0.8em;\n  font-weight: 700;\n  border-color: #555;\n  color: #555;\n  display: block;\n  opacity: 0.7;\n  font-weight: 400;\n  margin-bottom: 10px;\n  cursor: pointer;\n}\n.basket .send-methods li .description {\n  margin-right: 5px;\n}\n.basket .send-methods li .cost {\n  margin-left: 5px;\n}\n.basket .send-methods li.selected,\n.basket .send-methods li:hover {\n  border-color: #d882a5;\n  color: #555;\n  font-weight: 700;\n  opacity: 1;\n}\n.basket .send-methods li.selected .description,\n.basket .send-methods li:hover .description,\n.basket .send-methods li.selected .cost,\n.basket .send-methods li:hover .cost {\n  color: #555;\n}\n.concessions-container {\n  position: fixed;\n  width: 100vw;\n  height: 100vh;\n  background-color: rgba(255, 255, 255, 0.8);\n  z-index: 2;\n}\n.concessions-container .content {\n  background-color: #ffffff;\n  position: absolute;\n  transform: translate(-50%, -50%);\n  top: 50%;\n  left: 50%;\n  width: 40%;\n  max-width: 400px;\n  border-radius: 10px;\n  padding: 20px;\n  padding-top: 0;\n  box-shadow: 0px 0px 18px 1px #d9d6d9;\n}\n.concessions-container .content .title {\n  text-align: center;\n  font-size: 700;\n}\n.concessions-container .content ul li {\n  background-color: #ffffff;\n  margin: 5px;\n  margin-left: 0;\n  padding: 5px 25px;\n  border-radius: 50px;\n  display: inline-block;\n  border: 1px solid #d882a5;\n  font-size: 0.8em;\n  font-weight: 700;\n  cursor: pointer;\n  border-color: #555;\n  opacity: 0.3;\n  display: block;\n  margin-bottom: 15px;\n  text-align: center;\n  font-weight: 400;\n}\n.concessions-container .content ul li:hover,\n.concessions-container .content ul li.selected {\n  background-color: #d882a5;\n  color: #ffffff;\n}\n.concessions-container .content ul li:hover,\n.concessions-container .content ul li.selected {\n  border-color: #d882a5;\n  opacity: 1;\n  background-color: #ffffff;\n  color: #555;\n  font-weight: 700;\n}\n.concessions-container .content .button-close {\n  position: absolute;\n  top: 10px;\n  right: 14px;\n  color: #f4b793;\n  cursor: pointer;\n  font-size: 1.7em;\n}\n.concessions-container .content .button-close:hover {\n  color: #d66d8d;\n}\n.checkout-container {\n  position: fixed;\n  width: 100vw;\n  height: 100vh;\n  background-color: rgba(255, 255, 255, 0.8);\n  z-index: 2;\n}\n.checkout-container .content {\n  background-color: #ffffff;\n  position: absolute;\n  transform: translate(-50%, -50%);\n  top: 50%;\n  left: 50%;\n  width: 60%;\n  max-width: 700px;\n  border-radius: 10px;\n  padding: 20px;\n  padding-top: 0;\n  text-align: center;\n  box-shadow: 0px 0px 18px 1px #d9d6d9;\n}\n.checkout-container .content .title {\n  font-weight: 700;\n  font-size: 1.3em;\n  letter-spacing: 1px;\n}\n.checkout-container .content .subtitle {\n  text-align: center;\n  font-size: 1em;\n  border-top: 1px solid #eaeaea;\n  padding-top: 13px;\n}\n.checkout-container .content .send-method,\n.checkout-container .content .transaction-uuid {\n  background-color: #ffffff;\n  margin: 5px;\n  margin-left: 0;\n  padding: 5px 25px;\n  border-radius: 50px;\n  display: inline-block;\n  border: 1px solid #d882a5;\n  font-size: 0.8em;\n  font-weight: 700;\n  display: block;\n}\n.checkout-container .content ul li {\n  background-color: #ffffff;\n  margin: 5px;\n  margin-left: 0;\n  padding: 5px 25px;\n  border-radius: 50px;\n  display: inline-block;\n  border: 1px solid #d882a5;\n  font-size: 0.8em;\n  font-weight: 700;\n  margin-bottom: 10px;\n  display: block;\n}\n.checkout-container .content .button-close {\n  position: absolute;\n  top: 10px;\n  right: 14px;\n  color: #f4b793;\n  cursor: pointer;\n  font-size: 1.7em;\n}\n.checkout-container .content .button-close:hover {\n  color: #d66d8d;\n}\n.event-content {\n  position: fixed;\n  right: 0;\n  top: 0;\n  overflow: auto;\n  height: 100vh;\n  width: calc(100vw - 225px);\n  background-color: #ffffff;\n  padding-left: 20px;\n  box-sizing: border-box;\n  z-index: 3;\n}\n.event-content .close-button {\n  position: absolute;\n  right: 10px;\n  top: 10px;\n  cursor: pointer;\n  color: #555;\n  z-index: 1;\n  font-size: 1.7em;\n}\n.event-content .close-button:hover {\n  opacity: 0.7;\n}\n.event-content .react-json-view {\n  padding-top: 20px;\n}\n.add-seat-list {\n  padding-left: 48px;\n}\n.add-seat-list li {\n  padding-left: 10px;\n  padding-top: 7px;\n  padding-bottom: 7px;\n}\n.add-seat-list li:hover {\n  background-color: #f8f9fa;\n}\n.choose-perf-container,\n.choose-event-container,\n.choose-domain-container {\n  text-align: center;\n  padding-left: 10px;\n  padding-right: 15px;\n  padding-top: 10px;\n  padding-bottom: 10px;\n}\n.choose-perf-container input,\n.choose-event-container input,\n.choose-domain-container input {\n  display: inline-block;\n  width: 100%;\n  margin-bottom: 15px;\n  border: 0;\n  border: 1px dotted #ddd;\n  text-align: center;\n  font-size: 1em;\n  border-radius: 50px;\n  outline: 0;\n}\n.choose-perf-container button,\n.choose-event-container button,\n.choose-domain-container button {\n  background-color: #d882a5;\n  display: inline-block;\n  width: 100%;\n  padding: 5px 20px;\n  border-radius: 50px;\n  color: white;\n  border: 0;\n  font-size: 1em;\n  margin-bottom: 10px;\n  cursor: pointer;\n}\n.choose-perf-container button:hover,\n.choose-event-container button:hover,\n.choose-domain-container button:hover {\n  opacity: 0.7;\n}\n.chart-controls-container {\n  padding-left: 10px;\n  padding-right: 10px;\n}\n.chart-controls-container button {\n  background-color: #d882a5;\n  display: inline-block;\n  width: 100%;\n  padding: 5px 20px;\n  border-radius: 50px;\n  color: white;\n  border: 0;\n  font-size: 1em;\n  margin-bottom: 10px;\n  cursor: pointer;\n  display: block;\n  margin-left: auto;\n  margin-right: auto;\n}\n.chart-controls-container button:hover {\n  opacity: 0.7;\n}\n.chart-controls-container select {\n  background-color: #d882a5;\n  display: inline-block;\n  width: 100%;\n  padding: 5px 20px;\n  border-radius: 50px;\n  color: white;\n  border: 0;\n  font-size: 1em;\n  margin-bottom: 10px;\n  cursor: pointer;\n  height: 30px;\n  margin-bottom: 15px;\n  display: block;\n}\n.chart-controls-container select:hover {\n  opacity: 0.7;\n}\n.chart-controls-container .input-group {\n  margin-left: auto;\n  margin-right: auto;\n  margin-top: -10px;\n}\n.chart-controls-container input[type=\"text\"] {\n  display: inline-block;\n  width: 100%;\n  margin-bottom: 15px;\n  border: 0;\n  border: 1px dotted #ddd;\n  text-align: center;\n  font-size: 1em;\n  border-radius: 50px;\n  outline: 0;\n}\n.chart-controls-container label {\n  display: inline-block !important;\n  margin-left: 10px;\n}\n.chart-controls-container label:hover {\n  border: 0 !important;\n  background-color: transparent !important;\n}\n.chart-controls-container label:hover:before,\n.chart-controls-container label:hover:after {\n  display: none;\n}\n.error-modal-container {\n  position: fixed;\n  width: 100vw;\n  height: 100vh;\n  background-color: rgba(255, 255, 255, 0.8);\n  z-index: 2;\n}\n.error-modal-container .content {\n  background-color: #ffffff;\n  position: absolute;\n  transform: translate(-50%, -50%);\n  top: 50%;\n  left: 50%;\n  width: 40%;\n  max-width: 400px;\n  border-radius: 10px;\n  padding: 20px;\n  padding-top: 0;\n  box-shadow: 0px 0px 18px 1px #d9d6d9;\n}\n.error-modal-container .content .title {\n  text-align: center;\n  font-weight: 700;\n}\n.error-modal-container .content .message {\n  text-align: center;\n}\n.error-modal-container .content .button-close {\n  position: absolute;\n  top: 10px;\n  right: 14px;\n  color: #f4b793;\n  cursor: pointer;\n  font-size: 1.7em;\n}\n.error-modal-container .content .button-close:hover {\n  color: #d66d8d;\n}\n.main-container {\n  display: -ms-flexbox;\n  display: flex;\n  height: 100vh;\n  overflow: hidden;\n  background-color: #ffffff;\n  margin-right: 10px;\n}\n.main-content {\n  width: 100%;\n}\n.feather-container {\n  height: calc(100vh - 200px);\n  transition: 600ms;\n  transition-timing-function: ease-in-out;\n}\n.feather-container.minimised {\n  height: 0;\n}\nul {\n  list-style-type: none;\n  margin-left: 0;\n  padding-left: 0;\n}\niframe {\n  border: 0 !important;\n}\nbutton {\n  outline: 0;\n}\n", ""]);
...
var _basket = __webpack_require__(32);
...
var _concessions = __webpack_require__(43);

var _concessions2 = _interopRequireDefault(_concessions);

var _checkout = __webpack_require__(44);

var _checkout2 = _interopRequireDefault(_checkout);

var _event_content = __webpack_require__(45);

var _event_content2 = _interopRequireDefault(_event_content);

var _error_modal = __webpack_require__(47);
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.initFeather = _this.initFeather.bind(_this);
    _this.onSeatClick = _this.onSeatClick.bind(_this);
    _this.displayConcessions = _this.displayConcessions.bind(_this);
    _this.displayCheckout = _this.displayCheckout.bind(_this);
    _this.hideConcessions = _this.hideConcessions.bind(_this);
    _this.displayEventContent = _this.displayEventContent.bind(_this);
    _this.displayErrorModal = _this.displayErrorModal.bind(_this);

    // Feather imperative methods
    _this.removeSeat = _this.removeSeat.bind(_this);
    _this.selectSendMethod = _this.selectSendMethod.bind(_this);
    _this.reserveSeats = _this.reserveSeats.bind(_this);
    _this.selectConcession = _this.selectConcession.bind(_this);
    _this.addSeat = _this.addSeat.bind(_this);
    _this.selectColorScheme = _this.selectColorScheme.bind(_this);
    _this.halvePrices = _this.halvePrices.bind(_this);
    _this.chooseDomain = _this.chooseDomain.bind(_this);
    _this.chooseEvent = _this.chooseEvent.bind(_this);
    _this.choosePerf = _this.choosePerf.bind(_this);
    _this.changeChartBackgroundColor = _this.changeChartBackgroundColor.bind(_this);

    // Feather callbacks
    _this.onAddSeat = _this.onAddSeat.bind(_this);
    _this.onRemoveSeat = _this.onRemoveSeat.bind(_this);
    _this.onNewAvailabilityData = _this.onNewAvailabilityData.bind(_this);
    _this.onNewSendMethodsData = _this.onNewSendMethodsData.bind(_this);
    _this.onUpdateConcessions = _this.onUpdateConcessions.bind(_this);
    _this.onUpdateBasket = _this.onUpdateBasket.bind(_this);
    _this.onGoToCheckout = _this.onGoToCheckout.bind(_this);
    _this.onEvent = _this.onEvent.bind(_this);
    _this.onError = _this.onError.bind(_this);
    _this.onReserveStopped = _this.onReserveStopped.bind(_this);
    _this.onEmptyBasket = _this.onEmptyBasket.bind(_this);
    return _this;
  }
  ...
  App.prototype.resetState = function resetState() {
    this.setState({
      basketIsExpanded: false,
      basket: {},
      availability: {},
  ...
  App.prototype.initFeather = function initFeather() {
    this.setState({ basketIsExpanded: false });

    var perfID = this.state.perfID;
    ...
    this.chart.changeColorScheme(["#FEB390", "#E56B92", "#3D45C6", "#5FCEB4", "#4090C0", "#C2C094", "#390040", "#444054", "#BEBBBB", "#7C9885", "#FFE6E8", "#8E3B46", "#A18276", "#FDE74C", "#3891A6", "#4C5B5C"]);
  ...
  App.prototype.onEmptyBasket = function onEmptyBasket() {
    this.setState({ basket: {}, canProceed: true });
  };

  App.prototype.onReserveStopped = function onReserveStopped() {
    this.setState({ basketIsExpanded: false });
  };

  App.prototype.onError = function onError(eventData) {
    this.setState({
  ...
  App.prototype.onEvent = function onEvent(eventData) {
    var newEvents = JSON.parse(JSON.stringify(this.state.events));
    var newEventData = JSON.parse(JSON.stringify(eventData));
    newEvents.unshift(newEventData);
    this.setState({ events: newEvents });
  };

  App.prototype.onSeatClick = function onSeatClick(e, seatData) {
    this.setState({ concessionsIsOpen: true, highlightedSeat: seatData });
  };

  App.prototype.onAddSeat = function onAddSeat(event) {
    this.setState({ basket: event.basket, canProceed: event.canProceed });
  };

  App.prototype.onRemoveSeat = function onRemoveSeat(event) {
    var basketIsExpanded = this.state.basketIsExpanded;
    if (!event.basket.seats || event.basket.seats.length === 0) {
      basketIsExpanded = false;
    }

    this.setState({ basket: event.basket, basketIsExpanded: basketIsExpanded, canProceed: event.canProceed });
  };

  App.prototype.onNewAvailabilityData = function onNewAvailabilityData(event) {
    this.setState({ availability: event.availability });
  };

  App.prototype.onNewSendMethodsData = function onNewSendMethodsData(event) {
    console.warn('NEW SEND METHODS');
    this.setState({ sendMethods: event.sendMethods });
  };

  App.prototype.onUpdateConcessions = function onUpdateConcessions(event) {
    this.setState({ basket: event.basket, concessions: event.concessions });
  };

  App.prototype.removeSeat = function removeSeat(e, seatUUID) {
    e.stopPropagation();
    this.chart.removeSeat(seatUUID);
  };

  App.prototype.selectSendMethod = function selectSendMethod(methodCode) {
    this.chart.selectSendMethod(methodCode);
    this.setState({ selectedMethod: methodCode });
  };

  App.prototype.reserveSeats = function reserveSeats() {
    this.chart.reserve();
    this.setState({ isWaitingForReserve: true });
  };

  App.prototype.onGoToCheckout = function onGoToCheckout(event) {
  ...
  App.prototype.onSeatsReserved = function onSeatsReserved(event) {
    this.setState({ isWaitingForReserve: false });
  };

  App.prototype.displayConcessions = function displayConcessions() {
    if (!this.state.concessionsIsOpen) {
      return null;
    }

    return _react2.default.createElement(_concessions2.default, {
  ...
  App.prototype.displayErrorModal = function displayErrorModal() {
    var _this2 = this;
    ...
    return _react2.default.createElement(_error_modal2.default, {
  ...
  App.prototype.displayCheckout = function displayCheckout() {
    var _this3 = this;
    ...
    return _react2.default.createElement(_checkout2.default, {
      ...
      onClose: function onClose(e) {
        return _this3.setState({ checkoutIsOpen: false });
      },
      transactionUUID: this.state.transactionUUID
    });
  };

  App.prototype.hideConcessions = function hideConcessions() {
    this.setState({ concessionsIsOpen: false });
  };

  App.prototype.selectConcession = function selectConcession(concessionCode) {
    this.chart.selectConcession(this.state.highlightedSeat.uuid, concessionCode);
    this.setState({ concessionsIsOpen: false });
  };

  App.prototype.onUpdateBasket = function onUpdateBasket(eventData) {
    this.setState({ basket: eventData.basket });
  };

  App.prototype.displayEventContent = function displayEventContent() {
    var _this4 = this;
    ...
    return _react2.default.createElement(_event_content2.default, {
      content: this.state.selectedEventFromLog,
      onClose: function onClose(e) {
        return _this4.setState({ selectedEventFromLog: null });
      }
    });
  };

  App.prototype.addSeat = function addSeat(seatID) {
    this.chart.selectSeats(seatID);
  };

  App.prototype.choosePerf = function choosePerf() {
    this.resetState();
    this.chart.selectPerformance(this.state.perfID);
  };

  App.prototype.chooseEvent = function chooseEvent(eventID) {
    this.initFeather();
  };

  App.prototype.chooseDomain = function chooseDomain() {
    this.initFeather();
  };

  App.prototype.selectColorScheme = function selectColorScheme(colorScheme) {
    this.chart.changeColorScheme(colorScheme);
  };

  App.prototype.changeChartBackgroundColor = function changeChartBackgroundColor() {
    this.chart.changeChartBackgroundColor(this.state.chartBackgroundColor);
  };

  App.prototype.halvePrices = function halvePrices() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(_sidebar2.default, {
        ...
        selectEvent: function selectEvent(selectedEvent) {
          return _this5.setState({ selectedEventFromLog: selectedEvent });
        },
        availability: this.state.availability,
        ...
        onChangeDomain: function onChangeDomain(domain) {
          return _this5.setState({ domain: domain });
        },
        onChangeEvent: function onChangeEvent(eventID) {
          return _this5.setState({ eventID: eventID });
        },
        onChangePerf: function onChangePerf(perfID) {
          return _this5.setState({ perfID: perfID });
        },
        chooseDomain: this.chooseDomain,
        chooseEvent: this.chooseEvent,
        choosePerf: this.choosePerf,
        chartBackgroundColor: this.state.chartBackgroundColor,
        onChangeChartBackgroundColor: function onChangeChartBackgroundColor(chartBackgroundColor) {
          return _this5.setState({ chartBackgroundColor: chartBackgroundColor });
        },
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement("div", { className: "feather-container " + featherClassNames }),
        _react2.default.createElement(_basket2.default
        // data
        , { basket: this.state.basket,
          availability: this.state.availability,
          sendMethods: this.state.sendMethods,
          ...
          , openBasket: function openBasket() {
            return _this5.setState({ basketIsExpanded: true });
          },
          closeBasket: function closeBasket() {
            return _this5.setState({ basketIsExpanded: false });
          },
...
var _send_methods = __webpack_require__(33);

var _send_methods2 = _interopRequireDefault(_send_methods);

var _basket_header = __webpack_require__(34);

var _basket_header2 = _interopRequireDefault(_basket_header);

var _seat_list = __webpack_require__(9);

var _seat_list2 = _interopRequireDefault(_seat_list);
...
var Basket = function (_Component) {
  ...
  function Basket(props) {
    ...
    _this.displaySeats = _this.displaySeats.bind(_this);
    _this.displayPart2 = _this.displayPart2.bind(_this);
    _this.displayProceedButton = _this.displayProceedButton.bind(_this);
    return _this;
  }

  Basket.prototype.displaySeats = function displaySeats() {
    var seats = [];
    if (!this.props.basket || !this.props.basket.seatBundles) {
      return null;
    }
    return _react2.default.createElement(_seat_list2.default, _extends({}, this.props, { seatsAreRemovable: true }));
  };

  Basket.prototype.displayPart2 = function displayPart2() {
    if (!this.props.expanded) {
      return null;
    }

    var reserveClassNames = "reserve";
    var reserveLabel = "Reserve";
    ...
    return _react2.default.createElement(
      "div",
      { className: "part-2" },
      _react2.default.createElement(_basket_header2.default, {
        message: "How do you want to receive your tickets?",
        icon: "paper-airplane"
      }),
      _react2.default.createElement(_send_methods2.default, {
      ...
      _react2.default.createElement(
        "button",
        { className: reserveClassNames, onClick: this.props.reserveSeats },
        reserveLabel
      )
    );
  };

  Basket.prototype.displayProceedButton = function displayProceedButton(basketIsActive) {
    var onClick = void 0;
    var proceedClassNames = ["proceed"];
    if (this.props.canProceed && basketIsActive || this.props.expanded) {
      proceedClassNames.push("enabled");
    }

    var proceedLabel = void 0;
    if (this.props.expanded) {
    ...
    return _react2.default.createElement(
      "button",
      { className: proceedClassNames.join(" "), onClick: onClick },
      proceedLabel
    );
  };

  Basket.prototype.render = function render() {
    var basketIsActive = false;
    if (this.props.basket && this.props.basket.seatBundles && this.props.basket.seatBundles.length > 0) {
      basketIsActive = true;
    }

    var classNames = ["basket"];
    if (basketIsActive) {
    ...
    var formattedTotal = void 0;

    if (this.props.basket && this.props.basket.hasOwnProperty("total")) {
      formattedTotal = (0, _utils.getFormattedPrice)(this.props.basket.total, this.props.availability.currency);
    }

    var headerMessage = "Your order summary";
    if (formattedTotal) {
      headerMessage += " (" + formattedTotal + ")";
    }
    var headerSubMessage = null;
    if (this.props.concessions && this.props.concessions.length > 1 && this.props.basket.seats && this.props.basket.seats.length > 0) {
...
var SendMethods = function (_Component) {
  _inherits(SendMethods, _Component);

  function SendMethods(props) {
    _classCallCheck(this, SendMethods);

    var _this = _possibleConstructorReturn(this, _Component.call(this, props));

    _this.displaySendMethods = _this.displaySendMethods.bind(_this);
    return _this;
  }

  SendMethods.prototype.displaySendMethods = function displaySendMethods() {
    var _this2 = this;
    ...
    return this.props.methods.map(function (method) {
      var formattedCost = (0, _utils.getFormattedPrice)(method.cost, _this2.props.currency);
      var classNames = "";
      if (method.code === _this2.props.selectedMethod) {
        classNames += "selected";
      }
      return _react2.default.createElement(
        "li",
        {
          ...
          onClick: function onClick(e) {
            return _this2.props.selectSendMethod(method.code);
          }
        },
        _react2.default.createElement(
          "span",
  ...
  SendMethods.prototype.render = function render() {
    return _react2.default.createElement(
      "ul",
      { className: "send-methods" },
      this.displaySendMethods()
    );
  };
...
var BasketHeader = function (_Component) {
  _inherits(BasketHeader, _Component);

  function BasketHeader() {
    _classCallCheck(this, BasketHeader);

    return _possibleConstructorReturn(this, _Component.apply(this, arguments));
  }

  BasketHeader.prototype.render = function render() {
    var icon = void 0;
    if (this.props.icon) {
      icon = _react2.default.createElement("i", { className: "fa fa-" + this.props.icon });
    }
    return _react2.default.createElement(
      "div",
      { className: "header" },
...
var Seat = function (_Component) {
  ...
  function Seat(props) {
    ...
    _this.displayRemoveButton = _this.displayRemoveButton.bind(_this);
    _this.onClick = _this.onClick.bind(_this);
    return _this;
  }

  Seat.prototype.onClick = function onClick(e) {
    if (this.props.seat.concessions && this.props.seat.concessions.length > 1) {
      this.props.onClick(e, this.props.seat);
    }
  };

  Seat.prototype.displayRemoveButton = function displayRemoveButton() {
    var _this2 = this;
    ...
    return _react2.default.createElement("i", {
      ...
      onClick: function onClick(e) {
        return _this2.props.removeSeat(e, _this2.props.seat.uuid);
      }
    });
  };
  ...
  Seat.prototype.render = function render() {
    ...
    var label = block.desc + " " + seat.seat_id + " - ";
    var formattedPrice = void 0;
    var selectedConcessionIndex = null;

    if (seat.concessions && seat.concessions.length) {
      seat.concessions.forEach(function (concession, index) {
    ...
    if (selectedConcessionIndex) {
      formattedPrice = (0, _utils.getFormattedPrice)(seat.selectedConcession.seatprice + seat.selectedConcession.surcharge, currency);
      label += formattedPrice + " (" + seat.selectedConcession.description + ")";
    } else {
      if (legendItem) {
        formattedPrice = (0, _utils.getFormattedPrice)(legendItem.price, currency);
      } else {
...
var _event_log = __webpack_require__(37);

var _event_log2 = _interopRequireDefault(_event_log);

var _add_seat = __webpack_require__(38);

var _add_seat2 = _interopRequireDefault(_add_seat);

var _choose_perf = __webpack_require__(39);

var _choose_perf2 = _interopRequireDefault(_choose_perf);

var _choose_event = __webpack_require__(40);

var _choose_event2 = _interopRequireDefault(_choose_event);

var _choose_domain = __webpack_require__(41);

var _choose_domain2 = _interopRequireDefault(_choose_domain);

var _chart_controls = __webpack_require__(42);

var _chart_controls2 = _interopRequireDefault(_chart_controls);
...
var Sidebar = function (_Component) {
  ...
  Sidebar.prototype.displayAddSeat = function displayAddSeat() {
    return _react2.default.createElement(_add_seat2.default, {
      availability: this.props.availability,
      addSeat: this.props.addSeat
    });
  };

  Sidebar.prototype.displayChooseDomain = function displayChooseDomain() {
    return _react2.default.createElement(_choose_domain2.default, {
  ...
  Sidebar.prototype.displayChooseEvent = function displayChooseEvent() {
    return _react2.default.createElement(_choose_event2.default, {
  ...
  Sidebar.prototype.displayChoosePerf = function displayChoosePerf() {
    return _react2.default.createElement(_choose_perf2.default, {
  ...
  Sidebar.prototype.displayChartControls = function displayChartControls() {
    return _react2.default.createElement(_chart_controls2.default, this.props);
  };

  Sidebar.prototype.displayEventLog = function displayEventLog() {
    return _react2.default.createElement(_event_log2.default, {
      events: this.props.events,
      selectEvent: this.props.selectEvent
    });
  };

  Sidebar.prototype.toggleItem = function toggleItem(itemID) {
  ...
  Sidebar.prototype.displayItems = function displayItems() {
    var _this2 = this;
    ...
    return this.state.items.map(function (item) {
      ...
      if (item.selected) {
        ...
        content = _this2[item.showContentMethod].call(_this2);
      } else {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement("i", { className: "icon fa " + item.icon }),
          item.label,
          _react2.default.createElement("i", { className: "arrow fa " + arrowIcon })
        ),
        _react2.default.createElement(
          "div",
          { className: "content" },
  ...
  Sidebar.prototype.render = function render() {
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        "p",
        null,
        _react2.default.createElement("img", { className: "logo", src: "assets/feather-icon.png" })
      ),
      _react2.default.createElement(
        "ul",
        { className: "menu" },
...
var EventLog = function (_Component) {
  ...
  function EventLog(props) {
    ...
    _this.displayEventList = _this.displayEventList.bind(_this);
    return _this;
  }

  EventLog.prototype.displayEventList = function displayEventList() {
    var _this2 = this;
  ...
  EventLog.prototype.render = function render() {
    return _react2.default.createElement(
      "ul",
      { className: "event-log" },
...
var AddSeat = function (_Component) {
  _inherits(AddSeat, _Component);

  function AddSeat(props) {
    _classCallCheck(this, AddSeat);

    var _this = _possibleConstructorReturn(this, _Component.call(this, props));

    _this.displaySeatList = _this.displaySeatList.bind(_this);
    return _this;
  }

  AddSeat.prototype.displaySeatList = function displaySeatList() {
    var _this2 = this;
    ...
    var _loop = function _loop(seatID) {
      var seat = _this2.props.availability.seats[seatID];

      var ticketType = _this2.props.availability.seat_blocks[seat.seat_block].desc;
      var seatLabel = ticketType + " " + seat.seat_id;
      seats.push(_react2.default.createElement(
        "li",
        { key: seatLabel, onClick: function onClick(e) {
            return _this2.props.addSeat(seatID);
          } },
        seatLabel
      ));
    };

    for (var seatID in this.props.availability.seats) {
      _loop(seatID);
    }
    return seats;
  };

  AddSeat.prototype.render = function render() {
    return _react2.default.createElement(
      "ul",
      { className: "add-seat-list" },
      this.displaySeatList()
    );
  };
...
var ChoosePerf = function (_Component) {
  _inherits(ChoosePerf, _Component);

  function ChoosePerf() {
    _classCallCheck(this, ChoosePerf);

    return _possibleConstructorReturn(this, _Component.apply(this, arguments));
  }

  ChoosePerf.prototype.render = function render() {
    var _this2 = this;

    return _react2.default.createElement(
      "div",
      { className: "choose-perf-container" },
      ...
      _react2.default.createElement(
        "button",
        { onClick: function onClick(e) {
            return _this2.props.choosePerf();
          } },
        "Select"
      )
    );
...
var ChooseEvent = function (_Component) {
  _inherits(ChooseEvent, _Component);

  function ChooseEvent() {
    _classCallCheck(this, ChooseEvent);

    return _possibleConstructorReturn(this, _Component.apply(this, arguments));
  }

  ChooseEvent.prototype.render = function render() {
    var _this2 = this;
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        "small",
        null,
        "It will initially select the ",
        _react2.default.createElement("br", null),
        " first available performance"
      ),
      _react2.default.createElement("input", {
        value: this.props.value,
      ...
      _react2.default.createElement(
        "button",
        { onClick: function onClick(e) {
            return _this2.props.chooseEvent();
          } },
        "Select"
      )
    );
...
var ChooseDomain = function (_Component) {
  _inherits(ChooseDomain, _Component);

  function ChooseDomain() {
    _classCallCheck(this, ChooseDomain);

    return _possibleConstructorReturn(this, _Component.apply(this, arguments));
  }

  ChooseDomain.prototype.render = function render() {
    var _this2 = this;

    return _react2.default.createElement(
      "div",
      { className: "choose-domain-container" },
      _react2.default.createElement(
        "small",
        null,
        "This is the domain for the underlying website that Feather makes requests to"
      ),
      _react2.default.createElement("input", {
        value: this.props.value,
        placeholder: "Domain",
      ...
      _react2.default.createElement(
        "button",
        { onClick: function onClick(e) {
            return _this2.props.chooseDomain();
          } },
        "Select"
      )
    );
...
var ChartControls = function (_Component) {
  _inherits(ChartControls, _Component);

  function ChartControls(props) {
    _classCallCheck(this, ChartControls);
    ...
    _this.state = {
      colorSchemes: [{
        label: "Feather",
        colors: ["#FEB390", "#E56B92", "#3D45C6", "#5FCEB4", "#4090C0", "#C2C094", "#390040", "#444054", "#BEBBBB", "#7C9885", "#FFE6E8", "#8E3B46", "#A18276", "#FDE74C", "#3891A6", "#4C5B5C"]
      }, {
        label: "Sea Shells",
        colors: ["#f95e5e", "#071a24", "#265b76", "#60b2c2", "#dd9a8a", "#005cbb", "#c7e8f2", "#e5c7f2", "#f95e5e", "#071a24", "#265b76", "#60b2c2", "#dd9a8a", "#005cbb", "#c7e8f2", "#e5c7f2"]
      }, {
        label: "High Contrast",
        colors: ["#f95e5e", "#FFA726", "#42A5F5", "#fcabc7", "#8febf7", "#55cc5b", "#ae87f2", "#efdc32", "#018930", "#a37d70", "#455A64", "#7B1FA2", "#fc9292", "#aaaaaa", "#fcc18a", "#66FF99"]
      }, {
        label: "Pastel",
        colors: ["#462446", "#B05F6D", "#EB6B56", "#FFC153", "#47B39D", "#CDCBA6", "#008891", "#00587A", "#ff0000", "#0F3057"]
      }, {
        label: "Bold",
        colors: ["#8ea1b3", "#101415", "#ff2600", "#ed5165", "#839496", "#6ec14c", "#d7a302", "#0084cc", "#b433e1"]
      }, {
        label: "Grayscale",
        colors: ["#444", "#555", "#666", "#777", "#888", "#999", "#aaa", "#bbb", "#ccc", "#aaa", "#444", "#aaa", "#444", "#aaa", "#444", "#aaa"]
      }]
    };
    return _this;
  }

  ChartControls.prototype.displayColorSchemes = function displayColorSchemes() {
    return this.state.colorSchemes.map(function (colorScheme, index) {
      var props = {
  ...
  ChartControls.prototype.render = function render() {
    var _this2 = this;
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        {
          onChange: function onChange(e) {
            return _this2.props.selectColorScheme(e.target.value.split(","));
          }
        },
      ...
      _react2.default.createElement("input", {
        ...
        type: "text",
        onChange: function onChange(e) {
          return _this2.props.onChangeChartBackgroundColor(e.target.value);
        }
      }),
      _react2.default.createElement(
        "button",
        { onClick: this.props.changeChartBackgroundColor },
        "Change"
      ),
      _react2.default.createElement("br", null),
      _react2.default.createElement(
      ...
      _react2.default.createElement(
        "button",
        { onClick: this.props.showLegend },
        "Show Legend"
      ),
      _react2.default.createElement(
        "button",
        { onClick: this.props.hideLegend },
        "Hide Legend"
      ),
      _react2.default.createElement(
        "button",
      ...
      _react2.default.createElement(
        "button",
        { onClick: this.props.hideControls },
        "Hide Zoom Controls"
      ),
      _react2.default.createElement(
        "button",
        { onClick: this.props.halvePrices },
        "Halve Prices"
      )
    );
  };
...
var Concessions = function (_Component) {
  _inherits(Concessions, _Component);

  function Concessions(props) {
    _classCallCheck(this, Concessions);
  ...
  Concessions.prototype.displayItems = function displayItems() {
    var _this2 = this;
    ...
    return this.props.items.map(function (item) {
      var formattedTotalPrice = (0, _utils.getFormattedPrice)(item.seatprice + item.surcharge, _this2.props.currency);
      var classNames = "";
      if (item.code === _this2.props.selectedItem.code) {
        classNames += " selected";
      }
      return _react2.default.createElement(
        "li",
        {
          ...
          className: classNames,
          onClick: function onClick(e) {
            return _this2.props.onItemSelected(item.code);
          }
        },
        item.description,
        " - ",
  ...
  Concessions.prototype.render = function render() {
    return _react2.default.createElement(
      "aside",
...
var Checkout = function (_Component) {
  ...
  Checkout.prototype.render = function render() {
    ...
    var sendMethodDescription = this.props.sendMethods.filter(function (method) {
      return method.code === _this2.props.selectedMethod;
    })[0].description;
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          "ul",
          null,
          _react2.default.createElement(_seat_list2.default, _extends({}, this.props, { seatsAreRemovable: false }))
        ),
        _react2.default.createElement(
          "p",
          { className: "subtitle" },
          "The chosen send method"
        ),
        _react2.default.createElement(
          "p",
          { className: "send-method" },
...
var _reactJsonView = __webpack_require__(46);
...
var EventContent = function (_Component) {
  ...
  EventContent.prototype.render = function render() {
    return _react2.default.createElement(
      "aside",
      { className: "event-content" },
      _react2.default.createElement("i", { className: "fa fa-close close-button", onClick: this.props.onClose }),
