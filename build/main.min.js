...
var App = function (_Component) {
  ...
  App.prototype.initFeather = function initFeather(_ref) {
    ...
    this.chart.changeColorScheme(["#FEB390", "#E56B92", "#3D45C6", "#5FCEB4", "#4090C0", "#FEB390", "#E56B92", "#3D45C6", "#5FCEB4", "#4090C0", "#FEB390", "#E56B92", "#3D45C6", "#5FCEB4", "#4090C0"]);
  ...
  App.prototype.choosePerf = function choosePerf(perfID) {
    this.resetState();
    this.chart.selectPerformance(perfID);
  };

  App.prototype.chooseEvent = function chooseEvent(eventID) {
    this.initFeather({ eventID: eventID });
  };

  App.prototype.chooseDomain = function chooseDomain(domain) {
    this.initFeather({ domain: domain });
  };
...
var Sidebar = function (_Component) {
  ...
  Sidebar.prototype.displayChoosePerf = function displayChoosePerf() {
    return _react2.default.createElement(_choose_perf2.default, { choosePerf: this.props.choosePerf });
  };

  Sidebar.prototype.displayChooseEvent = function displayChooseEvent() {
    return _react2.default.createElement(_choose_event2.default, { chooseEvent: this.props.chooseEvent });
  };
  ...
  Sidebar.prototype.displayChooseDomain = function displayChooseDomain() {
    return _react2.default.createElement(_choose_domain2.default, this.props);
  };
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement("input", {
        ...
        onChange: function onChange(e) {
          return _this2.setState({ perfID: e.target.value });
        }
      }),
      ...
      _react2.default.createElement(
        "button",
        { onClick: function onClick(e) {
            return _this2.props.choosePerf(_this2.state.perfID);
          } },
        "Select"
      )
    );
  ...
  ChooseEvent.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement("input", {
        ...
        onChange: function onChange(e) {
          return _this2.setState({ eventID: e.target.value });
        }
      }),
      _react2.default.createElement("br", null),
      _react2.default.createElement(
        "button",
        { onClick: function onClick(e) {
            return _this2.props.chooseEvent(_this2.state.eventID);
          } },
        "Select"
      )
    );
  ...
  ChooseDomain.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement("input", {
        ...
        placeholder: "Domain",
        onChange: function onChange(e) {
          return _this2.setState({ domain: e.target.value });
        }
      }),
      _react2.default.createElement("br", null),
      _react2.default.createElement(
        "button",
        { onClick: function onClick(e) {
            return _this2.props.chooseDomain(_this2.state.domain);
          } },
        "Select"
      )
    );
