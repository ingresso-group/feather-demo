...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.onNewConcessionsData = _this.onNewConcessionsData.bind(_this);
    return _this;
  }
  ...
  App.prototype.onSeatClick = function onSeatClick(e) {
  ...
  App.prototype.onNewConcessionsData = function onNewConcessionsData(event) {
  ...
  App.prototype.selectConcession = function selectConcession(item) {
...
var Seat = function (_Component) {
  ...
  Seat.prototype.render = function render() {
    ...
    var formattedPrice = (0, _utils.getFormattedPrice)(legendItem.price, currency);
    ...
    return this.props.items.map(function (item) {
      ...
      return _react2.default.createElement(
        "li",
        {
          ...
          className: "classNames",
          onClick: function onClick(e) {
            return _this2.props.onItemSelected(item);
          }
        },
        item.description,
        " - ",
