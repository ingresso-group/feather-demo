...
export default class App extends Component {
    constructor(props) {
        ...
        this.changeChartBackgroundColor =
            this.changeChartBackgroundColor.bind(this);
    ...
    initFeather() {
        ...
        if (this.state.hide_currency_symbol)
            chartConfig.hide_currency_symbol = "hidden";
    ...
    halvePrices() {
        var newLegend = JSON.parse(
            JSON.stringify(this.state.availability.legend)
        );
            ...
            <div className="main-container">
                ...
                <div className="main-content">
                    ...
                    <Basket
                        ...
                        // callbacks
                        openBasket={() =>
                            this.setState({ basketIsExpanded: true })
                        }
                        closeBasket={() =>
                            this.setState({ basketIsExpanded: false })
                        }
