...
import SendMethods from "./send_methods";
import BasketHeader from "./basket_header";
...
export default class Basket extends Component {
        ...
        return (
            <div className="part-2">
                ...
                <button
                    ...
                    onClick={this.props.reserveSeats}
                >
                    {reserveLabel}
                </button>
            </div>
    ...
    render() {
        ...
        if (
            ...
            headerSubMessage =
                "(discounts available, click on a seat for more info)";
        }
